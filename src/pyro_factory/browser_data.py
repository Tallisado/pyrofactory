...
class BrowserData:
    def __init__(self, config):
        ...
        if os.environ.get('BROWSER'):
            if len(browser_mode.split(',')) == 3:
                ...
                print '(BrowserData) ERROR BROWSER found in commandline did not match requirements for sauce or local solo'
                # show usage
    ...
    def setPyrobotEnvForTest(self, i, config, test_name):
        ...
        os.environ["NO_SAUCE"] = "1" if use_cmdline_local_solo:
